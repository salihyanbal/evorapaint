...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "shopping_cart_items", uniqueConstraints = {@UniqueConstraint(name = "junction_unique",columnNames = { "shopping_cart_id", "product_id" })})
public class ShoppingCartItem {
    ...
    @NotNull(message = "Paket sayısı boş bırakılamaz")
